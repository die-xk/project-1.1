    ...
    <Container>
        <Row>
            ...
            <Col className='newe'>
                ...
                <Row><a href=""><h3 className='change-size'>Team</h3></a></Row>
                <Row><a href=""><h3 className='change-size'>Careers</h3></a></Row>
                <Row><a href=""><h3 className='change-size'>Partners</h3></a></Row>
                <Row><a href=""><h3 className='change-size'>Home</h3></a></Row>
            </Col>
        </Row>
    </Container>
    </div>
